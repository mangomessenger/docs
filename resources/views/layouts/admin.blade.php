                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="true" aria-expanded="false">Methods</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('admin.methods') }}">Methods</a>
                            <a class="dropdown-item" href="{{ route('admin.method-tags') }}">Tags</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-link text-primary underline" href="{{ route('home') }}"><u>Go on main
                                page</u></a>
                    </li>
                </ul>
